    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 aux = glm::rotate(glm::mat4(1), angle, right) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(aux.x, aux.y, aux.z));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            glm::vec4 aux = glm::rotate(glm::mat4(1), angle, up) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(aux.x, aux.y, aux.z));
            right = glm::cross(forward, up);
        }
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            right = glm::normalize(glm::vec3(aux.x, aux.y, aux.z));
            up = glm::cross(right, forward);
        }
